...
const commonStyles =
  'min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] justify-center items-center border-[0.5px] flex border-gray-400 text-sm font-light text-white';
    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 p-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <div className="grid sm:grid-cols-3 grid-cold-2 w-full mt-10">
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          ...
          <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
            ...
            <Input
              ...
              handleChange={handleChange}
            ></Input>
            <div className="h-[1px] w-full bg-gray-400 gy-2" />
            {isLoading ? (
              <Loader />
            ) : (
              <button
